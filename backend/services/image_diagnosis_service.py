...
class ImageDiagnosisService:
    ...
    MODALITY_CONFIG = {
        "skin": {
            "model_path": "models/weights/efficientnet_skin_disease.pth",
        ...
        "chest": {
            "model_path": "models/weights/efficientnet_chest_disease.pth",
            "default_backbone": "efficientnet_b0",
            "default_image_size": 224,
        ...
        "eye": {
            "model_path": "models/weights/efficientnet_eye_disease.pth",
            "default_backbone": "efficientnet_b0",
            "default_image_size": 224,
        ...
        "brain": {
            "model_path": "models/weights/efficientnet_brain_disease.pth",
            "default_backbone": "efficientnet_b0",
            "default_image_size": 224,
    ...
    def __init__(
        self,
        model_path: str = "models/weights/efficientnet_skin_disease.pth",
